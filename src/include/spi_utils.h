...
TSS_RESULT Transport_Quote(TSS_HCONTEXT, TCS_KEY_HANDLE, TCPA_NONCE *, UINT32, BYTE *, TPM_AUTH *,
			UINT32 *, BYTE **, UINT32 *, BYTE **);
TSS_RESULT RPC_DeepQuote(TSS_HCONTEXT, TCS_KEY_HANDLE, TCPA_NONCE *,UINT32, BYTE *, UINT32, BYTE *, UINT32,
		      TPM_AUTH *, UINT32 *, BYTE **);
...
struct tcs_api_table {
	...
	TSS_RESULT (*DeepQuote)(TSS_HCONTEXT, TCS_KEY_HANDLE, TCPA_NONCE *,UINT32, BYTE *, UINT32, BYTE *,
			    UINT32,TPM_AUTH *, UINT32 *, BYTE **);
#endif
